...
-- =====================================================
-- PART 1: Contract Templates (from 0013)
-- =====================================================
...
-- =====================================================
-- PART 2: DApp Templates (from 0015 with updates)
-- =====================================================

-- MNEE Staking DApp Template (with updated config from 0016)
...
-- MNEE DAO Voting DApp Template (with updated config from 0017)
INSERT INTO "Dapp_Template" ("id", "name", "description", "category", "defaultConfig")
VALUES (
...
-- MNEE Payment DApp Template (with updated config from 0017)
INSERT INTO "Dapp_Template" ("id", "name", "description", "category", "defaultConfig")
VALUES (
