...
export const LayoutDashboardIcon = ({ size = 16 }: { size?: number }) => {
  return (
    <svg
      height={size}
      strokeLinejoin="round"
    ...
    >
      <path
        clipRule="evenodd"
        d="M0 1.75C0 0.783502 0.783502 0 1.75 0H6.25C7.2165 0 8 0.783502 8 1.75V6.25C8 7.2165 7.2165 8 6.25 8H1.75C0.783502 8 0 7.2165 0 6.25V1.75ZM1.75 1.5C1.61193 1.5 1.5 1.61193 1.5 1.75V6.25C1.5 6.38807 1.61193 6.5 1.75 6.5H6.25C6.38807 6.5 6.5 6.38807 6.5 6.25V1.75C6.5 1.61193 6.38807 1.5 6.25 1.5H1.75ZM9 1.75C9 0.783502 9.7835 0 10.75 0H14.25C15.2165 0 16 0.783502 16 1.75V4.25C16 5.2165 15.2165 6 14.25 6H10.75C9.7835 6 9 5.2165 9 4.25V1.75ZM10.75 1.5C10.6119 1.5 10.5 1.61193 10.5 1.75V4.25C10.5 4.38807 10.6119 4.5 10.75 4.5H14.25C14.3881 4.5 14.5 4.38807 14.5 4.25V1.75C14.5 1.61193 14.3881 1.5 14.25 1.5H10.75ZM0 11.75C0 10.7835 0.783502 10 1.75 10H6.25C7.2165 10 8 10.7835 8 11.75V14.25C8 15.2165 7.2165 16 6.25 16H1.75C0.783502 16 0 15.2165 0 14.25V11.75ZM1.75 11.5C1.61193 11.5 1.5 11.6119 1.5 11.75V14.25C1.5 14.3881 1.61193 14.5 1.75 14.5H6.25C6.38807 14.5 6.5 14.3881 6.5 14.25V11.75C6.5 11.6119 6.38807 11.5 6.25 11.5H1.75ZM10.75 8C9.7835 8 9 8.7835 9 9.75V14.25C9 15.2165 9.7835 16 10.75 16H14.25C15.2165 16 16 15.2165 16 14.25V9.75C16 8.7835 15.2165 8 14.25 8H10.75ZM10.5 9.75C10.5 9.61193 10.6119 9.5 10.75 9.5H14.25C14.3881 9.5 14.5 9.61193 14.5 9.75V14.25C14.5 14.3881 14.3881 14.5 14.25 14.5H10.75C10.6119 14.5 10.5 14.3881 10.5 14.25V9.75Z"
        fill="currentColor"
        fillRule="evenodd"
      />
    </svg>
...
export const MessageSquareIcon = ({ size = 16 }: { size?: number }) => {
  return (
    ...
    >
      <path
        clipRule="evenodd"
        d="M2.5 3.25C2.5 2.83579 2.83579 2.5 3.25 2.5H12.75C13.1642 2.5 13.5 2.83579 13.5 3.25V10.75C13.5 11.1642 13.1642 11.5 12.75 11.5H8.5L5.5 14V11.5H3.25C2.83579 11.5 2.5 11.1642 2.5 10.75V3.25ZM3.25 1C2.00736 1 1 2.00736 1 3.25V10.75C1 11.9926 2.00736 13 3.25 13H4V15.5L8.5 13H12.75C13.9926 13 15 11.9926 15 10.75V3.25C15 2.00736 13.9926 1 12.75 1H3.25Z"
        fill="currentColor"
        fillRule="evenodd"
      />
    </svg>
...
export const StoreIcon = ({ size = 16 }: { size?: number }) => {
  return (
    <svg
      height={size}
      strokeLinejoin="round"
    ...
    >
      <path
        clipRule="evenodd"
        d="M1 2.5V1H15V2.5H14.5V6.5C14.5 7.05228 14.0523 7.5 13.5 7.5H13V14.5H14V16H2V14.5H3V7.5H2.5C1.94772 7.5 1.5 7.05228 1.5 6.5V2.5H1ZM3 2.5V6H4.5V2.5H3ZM6 2.5V6H7.25V2.5H6ZM8.75 2.5V6H10V2.5H8.75ZM11.5 2.5V6H13V2.5H11.5ZM4.5 7.5V14.5H7.25V11C7.25 10.5858 7.58579 10.25 8 10.25C8.41421 10.25 8.75 10.5858 8.75 11V14.5H11.5V7.5H4.5Z"
        fill="currentColor"
        fillRule="evenodd"
      />
    </svg>
...
export const EyeOffIcon = ({ size = 16 }: { size?: number }) => {
  return (
    ...
    >
      <path
        clipRule="evenodd"
        d="M2.21967 1.46967L1.68934 0.93934L0.62868 2L1.15901 2.53033L13.7803 15.1517L14.3107 15.682L15.3713 14.6213L14.8409 14.091L12.4693 11.7194C13.7289 10.6926 14.7602 9.40291 15.4549 7.99999C14.0233 5.11765 10.9741 3.5 7.99997 3.5C6.74714 3.5 5.52512 3.77321 4.40966 4.28033L2.21967 1.46967ZM5.52033 5.39099L6.93934 6.81L7.29289 7.16355C7.51295 7.05771 7.75 7 7.99997 7C8.82839 7 9.49997 7.67157 9.49997 8.5C9.49997 8.75 9.44226 8.98702 9.33642 9.20708L9.68997 9.56063L11.109 10.9796C12.1424 10.1648 13.0024 9.13291 13.6149 7.99999C12.3229 5.58824 10.0741 4.5 7.99997 4.5C7.12714 4.5 6.27512 4.68321 5.52033 5.39099ZM10.5 8.5C10.5 9.88071 9.38068 11 7.99997 11C7.61926 11 7.25997 10.9193 6.93934 10.7697L5.52033 9.35066C5.08068 8.71997 4.99997 8.11926 4.99997 8.5C4.99997 7.11929 6.11926 6 7.49997 6C7.88068 6 8.23997 6.08071 8.56063 6.23033L10.5 8.5ZM2.38503 7.99999C3.09753 6.56765 4.17997 5.35294 5.52033 4.39099L4.10966 2.98033C2.57512 3.97321 1.27289 5.38235 0.545059 7.99999C1.97668 10.8823 5.02585 12.5 7.99997 12.5C9.25281 12.5 10.4748 12.2268 11.5903 11.7197L10.1797 10.309C9.47997 10.7193 8.75 11 7.99997 11C5.92585 11 3.67712 9.91176 2.38503 7.99999Z"
        fill="currentColor"
        fillRule="evenodd"
      />
    </svg>
...
export const RefreshCwIcon = ({ size = 16 }: { size?: number }) => {
  return (
    ...
    >
      <path
        clipRule="evenodd"
        d="M2.5 8C2.5 4.96243 4.96243 2.5 8 2.5C9.80619 2.5 11.4033 3.39875 12.3536 4.77778L12.5 5H10.75H10V6.5H10.75H14.25C14.6642 6.5 15 6.16421 15 5.75V2.25V1.5H13.5V2.25V4.05C12.2847 2.19057 10.2773 1 8 1C4.13401 1 1 4.13401 1 8C1 11.866 4.13401 15 8 15C10.7614 15 13.1461 13.4191 14.2929 11.0858L14.5 10.6642L13.6569 10.25L13.4497 10.6716C12.5192 12.5621 10.4386 13.5 8 13.5C4.96243 13.5 2.5 11.0376 2.5 8Z"
        fill="currentColor"
        fillRule="evenodd"
      />
    </svg>
...
export const CreditCardIcon = ({ size = 16 }: { size?: number }) => {
  return (
    <svg
      height={size}
      strokeLinejoin="round"
    ...
    >
      <path
        clipRule="evenodd"
        d="M0 3.5C0 2.67157 0.671573 2 1.5 2H14.5C15.3284 2 16 2.67157 16 3.5V12.5C16 13.3284 15.3284 14 14.5 14H1.5C0.671573 14 0 13.3284 0 12.5V3.5ZM1.5 3.5H14.5V5H1.5V3.5ZM1.5 6.5V12.5H14.5V6.5H1.5ZM3 9.5H6V10.5H3V9.5Z"
        fill="currentColor"
        fillRule="evenodd"
      />
    </svg>
